<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-md d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            <a href="/index.php"> <img src="/images/logo_m2.png" alt="Logo" class="me-2"> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Pagamentos</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Dados Pessoais</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <a class="navbar-brand" href="/index.php">INTRANET - M2 SHOWS</a>
</nav>