...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    foreach ($cartoes as $numero) {
        ...
        if ($result->num_rows > 0) {
            ...
            // Obter nome e função do responsável atual da entrega
            ...
            $conn->query($sql);
            $mensagem_sucesso .= "Cartão $numero utilizado com sucesso.<br>";
        } else {
            $mensagem_erro .= "Cartão $numero não está disponível para utilização.<br>";
        }
    }
}
?>
...
<head>
    ...
    <title>Utilização de Cartões</title>
                    ...
                    <div class="table-container">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="">
                                ...
                                <button type="submit" class="btn btn-success"><span class="bi-save"></span>&nbsp;Registrar Utilização</button>
                            </form>
