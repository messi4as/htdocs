...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    foreach ($cartoes as $numero) {
        ...
        if ($result->num_rows > 0) {
            ...
            $conn->query($sql);
            $mensagem_sucesso .= "Cartão $numero devolvido com sucesso.<br>";
        } else {
            $mensagem_erro .= "Cartão $numero não está disponível para Devolução.<br>";
        }
    }
}
?>
...
<head>
    ...
    <title>Devolução de Cartões</title>
                    ...
                    <div class="table-container">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="">
                                ...
                                <div class="form-container">
                                    <div class="form-group">
                                        <label for="data_utilizacao" class="form-label">Data de Devolução:</label>
                                ...
                                <button type="submit" class="btn btn-success"><span class="bi-save"></span>&nbsp;Registrar Devolução</button>
                            </form>
