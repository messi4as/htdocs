...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    for ($i = 1; $i <= $quantidade_parcelas; $i++) {
        ...
        $valor_resp1 = 'R$ ' . number_format(round($valor_parcela * $percentual_responsavel1, 2), 2, ',', '.');
        $valor_resp2 = 'R$ ' . number_format(round($valor_parcela * $percentual_responsavel2, 2), 2, ',', '.');
