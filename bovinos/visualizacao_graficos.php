...
<head>
    ...
    <title>GRÁFICO POR AGRUPAMENTO</title>
    <style>
        @media print {
...
<body>
    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header">
                <h4 class="mb-0">GRÁFICO POR AGRUPAMENTO
                    <button class="btn btn-danger float-end" onclick="window.history.back();"><span class="bi-arrow-left-circle"></span>&nbsp;Voltar</button>
                    <a href="grafico_estratificacao.php" class="btn btn-warning me-2 float-end"><span class="bi bi-bar-chart"></span>&nbsp;Ver Gráfico por Estratificação</a>
                </h4>
            </div>
            <div class="card-body">
                <form method="GET" action="" class="mb-4 no-print">
                    ...
                    <a href="visualizacao_graficos.php" class="btn btn-outline-secondary">Limpar</a>
                </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const labels = bovinosData.map(item => item.agrupamento || 'SEM GRUPO');
